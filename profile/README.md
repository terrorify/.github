...
[![Feather Client](https://img.shields.io/badge/Feather-Server_API-AA00FF?style=for-the-badge&logo=feather&logoColor=white)](https://docs.feathermc.com/)
...
| **Client Integrations** | [**`Apollo`**](https://apollo.lunarclient.dev/) • [**`Badlion`**](https://github.com/BadlionClient/BadlionClientModAPI) • [**`Feather`**](https://docs.feathermc.com/) • [**`Alpine`**](https://github.com/alpine-client/ridge) • [**`NoRisk`**](https://docs.norisk.gg/) • [**`LabyMod`**](https://dev.labymod.net/) • [**`WhatsMyClient`**](https://github.com/terrorify/WhatsMyClient) | Cross-client identification, Universal Mod Enforcer rules, and native protocol hooks across all major custom clients. |
...
|:---|:---|:---|
| [**`WhatsMyClient`**](https://github.com/terrorify/WhatsMyClient) | Accurate Minecraft client identification and Universal Cross-Client Mod Enforcer SDK supporting Lunar, Badlion, Feather, Alpine, NoRisk, and LabyMod. | `Kotlin` • `Java` • `Netty` • `Network Protocol` |
